						...
						if(empty($author_name) OR empty($author_email) OR empty($author_bio)){
							...
							if(!filter_var($author_email, FILTER_VALIDATE_EMAIL)){
								...
								if(empty($author_password)){
									...
									$sql = "UPDATE `authorr` SET author_name='$author_name', author_email='$author_email', author_bio='$author_bio' WHERE author_id='$author_id';";
									...
									$author_id = $_SESSION['author_id'];
									$sql = "UPDATE `authorr` SET author_name='$author_name', author_email='$author_email', author_bio='$author_bio', author_password='$hash' WHERE author_id='$author_id';";
									if(mysqli_query($conn, $sql)){										
										session_unset();
										session_destroy();
