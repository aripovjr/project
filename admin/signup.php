		...
		<?php 
			if(isset($_POST['signup'])){
				...
				if(!filter_var($author_email,FILTER_VALIDATE_EMAIL)){
					...
					//If email exists
					$sql2 = "SELECT * FROM `authorr` WHERE `author_email`='$author_email'";
					...
					if(mysqli_num_rows($result)>0){
						...
						//Signing Up the USER
						$sql = "INSERT INTO `authorr` (`author_name`, `author_email`, `author_password`, `author_bio`, `author_role`) VALUES ('$author_name', '$author_email', '$hash', 'Enter Bio', 'author')";
